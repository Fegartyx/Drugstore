...
@section('main')
    <div class="container mt-lg-5">
        <div class="row justify-content-center">
            <div class="col-md-4 mb-4 mt-lg-5">
                        ...
                        <form action="/features/cart-store" method="POST">
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="text" class="form-control" id="itemName" placeholder="Pilih barang..."
                                        readonly>
                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <input type="number" min="1" value="1" class="form-control" name="quantity"
                                        id="itemQty" placeholder="Masukkan jumlah..." required>
                                    <div class="input-group-append">
            ...
            <div class="col-md-6 mt-lg-5">
                <div class="card mt-lg-5">
                    ...
                    <div class="card-body">
                        <form action="/features/transactions" method="post">
                            @csrf
                            <div class="form-group row">
                                ...
                                <div class="input-group col-sm-10">
                                    ...
                                    <input type="number" class="form-control" name="total"
                                        value="{{ $itemCarts->sum(function ($item) {
                            ...
                            <div class="form-group row">
                                ...
                                <div class="input-group col-sm-10">
                                    ...
                                    <input type="number" class="form-control" name="pay_total" placeholder="0"
                                        min="{{ $itemCarts->sum(function ($item) {
                                            return $item->price * $item->cart->quantity;
                                        }) }}"
                                        required>
                                </div>
